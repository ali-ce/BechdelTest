...
data = {"MovieId" : [movieID.attrib['id'] for movieid in root.cssselect("div[class='movie'] a"), "Movie" : [title.text_content().encode('utf-8')] for title in root.cssselect("div[class='movie'] a")}
